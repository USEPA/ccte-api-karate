...
#Projection checks
  ...
  Scenario: Validating the response of the GET method for chemical details by dtxsid (projection = ccdchemicaldetails) 
    ...
    When method GET
    Then status 200
    And match response == {id: '#present', pubchemCount: '##notnull', pubmedCount: '##notnull', sourcesCount: '##notnull', qcLevel: '#present', qcLevelDesc: '#present', isotope: '#present', multicomponent: '#present', totalAssays: '##notnull', toxcastSelect: '##notnull', pubchemCid: '##notnull', relatedSubstanceCount: '#present', relatedStructureCount: '#present', hasStructureImage: '#present', dtxsid: '#present', dtxcid: '#present', casrn: '#present', compoundId: '#present', genericSubstanceId: '#present', preferredName: '#present', activeAssays: '##notnull', cpdataCount: '##notnull', molFormula: '#present', monoisotopicMass: '#present', percentAssays: '##notnull', iupacName: '#present', smiles: '#present', inchiString: '#present', averageMass: '#present', inchikey: '#present', qcNotes: '#present', qsarReadySmiles: '#present', msReadySmiles: '#present', irisLink: '##notnull', pprtvLink: '##notnull', wikipediaArticle: '##notnull', isMarkush: '#present', stereo: '#present'}
